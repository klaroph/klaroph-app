...
export default function DashboardMonthStatStrip({
  ...
  return (
    <section
      ...
      aria-busy={loading}
    >
      <article className="dash-stat-card dash-stat-card--income">
        ...
        <div className="dash-stat-body">
          ...
          <p className="dash-stat-value tabular-nums">{formatCurrency(income)}</p>
        </div>
      </article>

      <article className="dash-stat-card dash-stat-card--expense">
        <div className="dash-stat-icon" aria-hidden>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="dash-stat-body">
          ...
          <p className="dash-stat-value tabular-nums">{formatCurrency(expenses)}</p>
        </div>
      </article>

      <article className="dash-stat-card dash-stat-card--net">
        <div className="dash-stat-icon" aria-hidden>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
            <path d="M3 3v18h18" />
      ...
      <article className="dash-stat-card dash-stat-card--goals">
        <div className="dash-stat-icon" aria-hidden>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
