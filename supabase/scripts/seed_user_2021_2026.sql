-- Seed dummy expenses and income for user from Jan 2021 to Mar 2026.
-- Per month: at least 30 expenses, 2 income records.
...
BEGIN
  ...
  RAISE NOTICE 'Seeded expenses (30/month) and income (2/month) from Jan 2021 to Mar 2026 for user %', uid;
END $$;
